...
(1, 'Guerre en Iran : Trump menace de &laquo; couper l&rsquo;eau &raquo; dans tout le Moyen-Orient, les g&eacute;ographes perplexes', '<p><strong class="ng-star-inserted"><span class="ng-star-inserted"><img src="https://placehold.co/800x400/ff8c00/ffffff?text=Illustration+:+Trump+fermant+le+robinet+du+Moyen-Orient" alt="Donald Trump mena&ccedil;ant de couper l''eau au Moyen-Orient - Article parodique" width="484" height="242"></span></strong></p>
